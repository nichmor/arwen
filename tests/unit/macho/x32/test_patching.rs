...
#[rstest]
fn test_rpath_change(#[files("tests/data/macho/x32/exec/*")] bin_path: PathBuf) {
...
#[rstest]
fn test_rpath_remove(#[files("tests/data/macho/x32/exec/*")] bin_path: PathBuf) {
    let data_bytes = std::fs::read(&bin_path).unwrap();
...
#[rstest]
fn test_rpath_add(#[files("tests/data/macho/x32/exec/*")] bin_path: PathBuf) {
...
#[rstest]
fn test_change_dylib_id(#[files("tests/data/macho/x32/libs/*")] lib_path: PathBuf) {
...
#[rstest]
fn test_change_dylib_name(#[files("tests/data/macho/x32/libs/*")] bin_path: PathBuf) {
    let data_bytes = std::fs::read(&bin_path).unwrap();
